...
<head>
    ...
    <title>For The Record - FTR</title>
</head>
<body class="homepage">
    <div class="navbar">
        <div class="container">
    ...
    <div class="welcome">Welcome to <span class="ftr">For The Record</span>!</div>

    <div class="intro">
        <div class="albums">
            <ul class="covers">
                <li class="topimpabutterfly"><img src="covers/topimpabutterfly.jpg"></li>
                <li class="inrainbows"><img src="covers/inrainbows.jpg"></li>
                <li class="thatfeelsgood"><img src="covers/that!feelsgood.jpg"></li>
                <li class="abbeyroad"><img src="covers/abbeyroad.jpg"></li>
                <li class="liftyrskinnyfists"><img src="covers/liftyourskinnyfistslikeantennastoheaven.jpg"></li>
                <li class="agaetisbyrjun"><img src="covers/agaetisbyrjun.jpg"></li>
                <li class="post"><img src="covers/post.jpg"></li>
                <li class="dangerouslyinlove"><img src="covers/dangerouslyinlove.jpg"></li>                
            </ul>
        </div>

        <div class="slogan">
            <span class="motto">Rate your favourite albums, make friends and pretend to be a music critic while actually just being chronically online.</span>
        </div>

        <div class="createaccount" onclick="location.href='register.php'">
