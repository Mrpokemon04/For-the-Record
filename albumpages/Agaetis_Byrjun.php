    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/agaetisbyrjun.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Agaetis Byrjun</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Sigur Ros</div>
            <div class="inputreleasedate">1999-06-12</div>
            <div class="inputgenre">post-rock</div>
        </div>
