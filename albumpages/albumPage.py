...
try:
    ...
    if conn.is_connected():
        ...
        cursor.execute('SELECT `name`,`artist`,`date`,`genre`,`cover` FROM `albums`')
        ...
        for album, artist, date, genre, cover in zip(albums, artists, dates, genres, covers):
