    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/bonitogeneration.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Bonito Generation</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Kero Kero Bonito</div>
            <div class="inputreleasedate">2016-10-21</div>
            <div class="inputgenre">electropop</div>
        </div>
