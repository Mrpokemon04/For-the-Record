    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/revolver.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Revolver</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">The Beatles</div>
            <div class="inputreleasedate">1966-08-05</div>
            <div class="inputgenre">pop rock,psychedelic rock</div>
        </div>
