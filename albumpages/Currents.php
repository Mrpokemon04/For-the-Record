    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/currents.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Currents</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputreleasedate">2015-07-17</div>
            <div class="inputgenre">psychedelic-pop,synthpop,neo-psychedelia</div>
        </div>
