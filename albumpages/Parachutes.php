    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/parachutes.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Parachutes</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Coldplay</div>
            <div class="inputreleasedate">2000-11-07</div>
            <div class="inputgenre">post-britpop,pop rock</div>
        </div>
