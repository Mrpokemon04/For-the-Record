    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/mezzanine.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Mezzanine</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Massive Attack</div>
            <div class="inputreleasedate">1998-04-20</div>
            <div class="inputgenre">trip hop,post-industrial</div>
        </div>
