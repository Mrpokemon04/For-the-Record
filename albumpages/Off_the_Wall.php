    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/offthewall.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Off the Wall</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Michael Jackson</div>
            <div class="inputreleasedate">1979-08-10</div>
            <div class="inputgenre">disco</div>
        </div>
