    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/lonerism.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Lonerism</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Tame Impala</div>
            <div class="inputreleasedate">2012-10-05</div>
            <div class="inputgenre">neo-psychedelia,psychedelic-rock</div>
        </div>
