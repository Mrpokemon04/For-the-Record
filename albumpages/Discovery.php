    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/discovery.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Discovery</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Daft Punk</div>
            <div class="inputreleasedate">2001-03-13</div>
            <div class="inputgenre">french house</div>
        </div>
