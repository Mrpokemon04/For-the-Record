    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/thevelvetunderground&nico.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">The Velvet Underground & Nico</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">The Velvet Underground & Nico</div>
            <div class="inputreleasedate">1967-03-12</div>
            <div class="inputgenre">art rock,experimental rock</div>
        </div>
