    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/whatsgoingon.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">What's Going On</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Marvin Gaye</div>
            <div class="inputreleasedate">1971-05-21</div>
            <div class="inputgenre">soul</div>
        </div>
