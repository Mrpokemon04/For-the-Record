    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/renaissance.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Renaissance</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Beyonce</div>
            <div class="inputreleasedate">2022-07-29</div>
            <div class="inputgenre">dance-pop,house,contemporaryr&b</div>
        </div>
