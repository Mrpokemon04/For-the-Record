    ...
    <head>
        ...
        <title>Mr. Morale & The Big Steppers</title>
    </head>
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/mrmorale&thebigsteppers.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Mr. Morale & The Big Steppers</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Kendrick Lamar</div>
            <div class="inputreleasedate">2022-05-13</div>
            <div class="inputgenre">conscious hip-hop,west coast hip hop</div>
        </div>
