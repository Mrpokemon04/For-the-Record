    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/hitmehardandsoft.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Hit Me Hard and Soft</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Billie Eilish</div>
            <div class="inputreleasedate">2004-05-17</div>
            <div class="inputgenre">alt-pop</div>
        </div>
