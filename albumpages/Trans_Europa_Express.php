    ...
    <head>
        ...
        <title>Trans Europa Express</title>
    </head>
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/transeuropaexpress.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Trans Europa Express</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Kraftwerk</div>
            <div class="inputreleasedate">1977-03-01</div>
            <div class="inputgenre">electronic,progressive-electronic</div>
        </div>
