    ...
    <body class="albumpage">
        ...
        <style>
            .albumpage .albumphoto {
                background-image: url(../covers/igor.jpg);
                background-size: cover;
            }
        </style>

        <div class="albumname">Igor</div>
        ...
        <div class="albuminfo">
            ...
            <div class="inputartistname">Tyler, the Creator</div>
            <div class="inputreleasedate">2019-05-17</div>
            <div class="inputgenre">neo-soul</div>
        </div>
